...
##Note: This version is a designated for swift 4 and version numbers reflect the version of swift supported. Note that version numbers are no longer prepended with a `v` e.g. v4.0.0
